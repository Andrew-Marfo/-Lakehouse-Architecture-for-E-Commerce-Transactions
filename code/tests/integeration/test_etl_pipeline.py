...
from code.glue_scripts.product_etl import deduplicate_data, products_schema
from code.glue_scripts.orders_etl import deduplicate_data as orders_deduplicate, orders_schema
from code.glue_scripts.order_items_etl import deduplicate_data as order_items_deduplicate, order_items_schema
...
def test_etl_pipeline(spark, s3_client, tmp_path):
    ...
    order_items_data = ("id,order_id,user_id,days_since_prior_order,product_id,add_to_cart_order,"
    ...
    validated_products = validate_dataframe(
        products_df, products_schema, "product_id",
    ...
    validated_orders = validate_dataframe(
        orders_df, orders_schema, "order_id",
    ...
    validated_order_items = validate_dataframe(
        order_items_df, order_items_schema, "id",
